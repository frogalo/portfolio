                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="p-6 flex items-center">
                                ...
                                {iconSrc ? (
                                    <div
                                        className="w-12 h-12 flex items-center justify-center bg-secondary rounded-lg mr-4 p-2 flex-shrink-0">
                                        <Image
                                            src={iconSrc}
                                            alt={`${skill.name} icon`}
                                            className="w-8 h-8"
                                        ...
                                        <div className="px-6 pb-6">
                                            <div className="border-t border-primary/20 pt-6">
                                                <div className="flex items-center gap-3 mb-4">
                                                    <div
                                                        className="h-0.5 bg-gradient-to-r from-accent via-purple-accent to-gold-accent flex-1 rounded-full"></div>
                                                    ...
                                                    <div
                                                        className="h-0.5 bg-gradient-to-l from-accent via-purple-accent to-gold-accent flex-1 rounded-full"></div>
                                                </div>
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                                                    {skill.subSkills.map((subSkill, subIndex) => (
                                                        ...
                                                        >
                                                            {/* Background gradient */}
                                                            <div
                                                                className="absolute inset-0 bg-gradient-to-br from-primary-lighter via-secondary/20 to-accent/10 rounded-lg opacity-50 group-hover:opacity-80 transition-opacity duration-300"></div>

                                                            {/* Content */}
                                                            <div
                                                                className="relative flex items-center gap-3 p-3 rounded-lg border border-primary/20 bg-background/80 backdrop-blur-sm hover:border-accent/50 transition-all duration-300 group-hover:shadow-lg">
                                                                {/* Animated dot with color cycling */}
                                                                <motion.div
                                                                    className={`w-3 h-3 rounded-full flex-shrink-0 ${getAccentColor(subIndex)}`}
                                                                ...
                                                                {/* Text */}
                                                                <span
                                                                    className="text-sm font-medium text-primary group-hover:text-accent transition-colors duration-300 leading-tight">
                                                                    {t(subSkill)}
                                                                </span>

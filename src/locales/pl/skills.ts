export const skills = {
    ...
    // Nowe umiejętności z plików danych
    "Figma": "Figma",
    "UI/UX": "UI/UX",
    "BPMN": "BPMN",
    ...
    "Slack API": "API Slack",
    "Diagrams": "Diagramy",
    "Auto-translations": "Automatyczne tłumaczenia",
    "AI Implementation": "Wdrażanie AI",
    "npm Package": "Paczka npm",
    "Colorful Logging": "Kolorowe logowanie",
    "Emoji Icons": "Ikony Emoji",
    "ADFS": "ADFS",
    "Google API": "API Google",
    "VLAN": "VLAN",
    "REST API": "API REST",
    "Serverless API": "API Serverless",
    "Discord.js": "Discord.js",
    "Java Spring Boot": "Java Spring Boot",
    "Ubuntu": "Ubuntu",
    "Backup Solutions": "Rozwiązania Backup",
    "Bash Scripting": "Skrypty Bash",
    "File upload": "Przesyłanie plików",
    "Graphs": "Wykresy",
    "Agile Development": "Metodyka Agile",
    "IT Project & Program Management": "Zarządzanie Projektami i Programami IT",
    "SaaS Management": "Zarządzanie SaaS",
    ...
    "Mobile Application Testing": "Testowanie Aplikacji Mobilnych",
    "Customer Experience": "Doświadczenie Klienta (CX)",
    "Research": "Badania",
    ...
    "Cascading Style Sheets (CSS)": "Arkusze Stylów (CSS)",
    "Content Management Systems (CMS)": "Systemy Zarządzania Treścią (CMS)",

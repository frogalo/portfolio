...
import { deleteExperience, toggleExperienceVisibility } from "./actions";
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col gap-2" onClick={(e) => e.stopPropagation()}>
                    <form action={async () => {
                      await toggleExperienceVisibility(entry.id, !entry.visible);
                      if (isSelected) {
                        setSelectedEntry({ ...entry, visible: !entry.visible });
                      }
                    }}>
                      <button className={`p-2 transition-colors ${entry.visible ? "text-secondary hover:text-on-surface" : "text-on-surface-variant hover:text-secondary"}`}>
